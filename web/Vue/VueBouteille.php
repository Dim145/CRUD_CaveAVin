        ...
        if("e instanceof bouteille") {
            return "<form action=".$_SERVER['PHP_SELF']."?table=".$_GET['table']." method='POST'>".
                        "<div class='fondTableau'><table>".
                            "<tr><td>nom_bouteille         </td><td>"." : "."<input type='text' name='nom_bouteille'         value=\"" . ($isForModifier ? $e->getNomBouteille() : "") . "\" required/></td></tr>" .
                            "<tr><td>volume_bouteille      </td><td>"." : "."<input type='text' name='volume_bouteille'      value=\"" . ($isForModifier ? $e->getVolumeBouteille() : "") . "\" required pattern='^(37.5|75|150|300|500|600|900|1200|1500|1800)$'
                                                                                  title='Doit être égale a 37.5,  75, 150, 300, 500, 600, 900, 1200, 1500 ou 1800'/></td></tr>" .
                            "<tr><td>millesime_bouteille   </td><td>"." : "."<input type='number' name='millesime_bouteille'   value=\"" . ($isForModifier ? $e->getMillesimeBouteille() : "") . "\" required min='1' max='2099' step='1'
