...
class Bouteille extends DatabaseObject
{
    ...
    public function toStringPageForm(bool $isForModifier = false ): string
    {
        return "<tr><td>nom_bouteille         </td><td>"." : "."<input type='text' name='nom_bouteille'         value=\"" . ($isForModifier ? $this->nom_bouteille : "") . "\" required/></td></tr>" .
               ...
               "<tr><td>millesime_bouteille   </td><td>"." : "."<input type='text' name='millesime_bouteille'   value=\"" . ($isForModifier ? $this->millesime_bouteille : "") . "\" required pattern='^((100)|([0-1]?[0-9]?[0-9]?[0-9]?)|([2][0][0-9][0-9]?))&(0-)$'
                                                                      title='Doit être entre 0 et 2099 non compris'/></td></tr>" .
               "<tr><td>prix_bouteille        </td><td>"." : "."<input type='number' name='prix_bouteille' min='1.00' step='0.1' value=\"" . ($isForModifier ? $this->prix_bouteille : "") . "\" required
